...
![screenshot-05](screenshots/week-04-screenshot-05.png)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![screenshot-06](screenshots/week-04-screenshot-06.png)
...
![screenshot-07](screenshots/week-04-screenshot-07.png)
...
![screenshot-08](screenshots/week-04-screenshot-08.png)
...
![screenshot-09](screenshots/week-04-screenshot-09.png)

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![screenshot-10](screenshots/week-04-screenshot-10.png)
...
![screenshot-11](screenshots/week-04-screenshot-11.png)

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![screenshot-12](screenshots/week-04-screenshot-12.png)
...
![screenshot-13](screenshots/week-04-screenshot-13.png)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![screenshot-14](screenshots/week-04-screenshot-14.png)

---

#### Screenshot 11 — Output of `git commit`

![screenshot-15](screenshots/week-04-screenshot-15.png)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![screenshot-16](screenshots/week-04-screenshot-16.png)
...
![screenshot-17](screenshots/week-04-screenshot-17.png)

---

#### Screenshot 14 — Output of `curl -I http://localhost` showing `HTTP/1.1 200 OK`

![screenshot-18](screenshots/week-04-screenshot-18.png)

---

#### Screenshot 15 — Browser showing the CodeTrack site loaded at `http://<EC2_PUBLIC_IP>`, with your Full Name and Group Name visible

![screenshot-19](screenshots/week-04-screenshot-19.png)
...
![screenshot-20](screenshots/week-04-screenshot-20.png)
